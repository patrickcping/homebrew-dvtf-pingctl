class DVTFPingCtl < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/patrickcping/dvtf-pingctl/releases/download/#{version}/dvtf-pingctl_darwin_arm64.tar.gz"
        sha256 "aa7d951d0de373aa6424b867965057805a6026dcdf8fd23f9ff53bf1fcae89f1"
      end
      on_intel do
        url "https://github.com/patrickcping/dvtf-pingctl/releases/download/#{version}/dvtf-pingctl_darwin_amd64.tar.gz"
    ...
    on_linux do
      on_arm do
        url "https://github.com/patrickcping/dvtf-pingctl/releases/download/#{version}/dvtf-pingctl_linux_arm64.tar.gz"
        sha256 "7a6c9bc1814a0c9580b6ab991c7ad12591149630e27cb9533eb697eba146a76b"
      end
      on_intel do
        url "https://github.com/patrickcping/dvtf-pingctl/releases/download/#{version}/dvtf-pingctl_linux_amd64.tar.gz"
